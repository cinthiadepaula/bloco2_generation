...
-- -----------------------------------------------------
-- Table `db_blog_pessoal`.`tbm_postagens`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_blog_pessoal`.`tbm_postagens` (
  `id` BIGINT NOT NULL,
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_tbm_postagens_tb_temas_idx` (`tb_temas_id` ASC) VISIBLE,
  INDEX `fk_tbm_postagens_tb_usuarios1_idx` (`tb_usuarios_id` ASC) VISIBLE,
  CONSTRAINT `fk_tbm_postagens_tb_temas`
    FOREIGN KEY (`tb_temas_id`)
    REFERENCES `db_blog_pessoal`.`tb_temas` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tbm_postagens_tb_usuarios1`
